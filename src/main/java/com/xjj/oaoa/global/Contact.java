...
public class Contact {
    ...
    //图片
    public static final String GM = "assets/img/avatars/5.jpg";
    public static final String FM = "assets/img/avatars/4.jpg";
    public static final String CASHIER = "assets/img/avatars/6.jpg";
    public static final String STAFF = "assets/img/avatars/3.jpg";
}
